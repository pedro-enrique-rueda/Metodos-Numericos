...
% codigo para Gauss - Seidel con relajación
...
% Esta parte analiza la convergencia 
% para ello, la matriz debe ser diagonal dominante.
...
%__________________________________________________________________________        
        % aplicando relajación
        x(i) = x(i)*alpha + (1 - alpha)*sol(k-1,i);
%__________________________________________________________________________        
        sol(k,i) = x(i);
    end
